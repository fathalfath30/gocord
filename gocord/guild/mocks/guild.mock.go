...
func (_m *GuildMock) Create(_a0 *guild.Guild) (*guild.Guild, error) {
	ret := _m.Called(_a0)

	var r0 *guild.Guild
	var r1 error
	if rf, ok := ret.Get(0).(func(*guild.Guild) (*guild.Guild, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(*guild.Guild) *guild.Guild); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
